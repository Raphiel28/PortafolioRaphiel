...
<a href="/archivos/CV-DesarrolladorDeSoftwareRaphiel.pdf" download="CV-DesarrolladorDeSoftwareRaphiel.pdf" onMouseEnter={MouseEnter} onMouseLeave={MouseLeave} onMouseDown={MouseDown} onMouseUp={MouseUp} className='button-DefaultHome me-4' style={buttonStyle}> Descargar CV
...
<a href="https://www.linkedin.com/in/raphiel-burdier-a9590b175/" target="_blank" className='button-DefaultIcon d-flex flex-row justify-content-center align-items-center me-4' >
...
<a href="https://github.com/Raphiel28" target="_blank"  className='button-DefaultIcon d-flex flex-row justify-content-center align-items-center me-4' >
...
<path d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"
        ...
        <div className='mt-5'>
            ...
            <img className='Presentacion-img' style={{}} src='/images/Perfil.png' alt=''/>
...
<a href="/archivos/CV-DesarrolladorDeSoftwareRaphiel.pdf" download="CV-DesarrolladorDeSoftwareRaphiel.pdf" onMouseEnter={MouseEnter} onMouseLeave={MouseLeave} onMouseDown={MouseDown} onMouseUp={MouseUp} className='button-DefaultHome me-3' style={buttonStyle}> Descargar CV
<svg className={classIco}  style={{width:'1.5rem', cursor:'pointer'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
<path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 242.7-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7 288 32zM64 352c-35.3 0-64 28.7-64 64l0 32c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-32c0-35.3-28.7-64-64-64l-101.5 0-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352 64 352zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"
          fill="#8750F7" stroke="#8750F7" stroke-width="2" />
</svg>
...
<a href="https://www.linkedin.com/in/raphiel-burdier-a9590b175/" target="_blank" className='button-DefaultIcon d-flex flex-row justify-content-center align-items-center me-3' >
<svg className='Pre-select-icon ' style={{width:'1rem', cursor:'pointer'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
...
<a href="https://github.com/Raphiel28" target="_blank" className='button-DefaultIcon d-flex flex-row justify-content-center align-items-center me-3' >
<svg className='Pre-select-icon ' style={{width:'1rem', cursor:'pointer'}} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
...
function FooterDown() {
 ...
 <img onClick={onclickImage} className='' src="/images/RaphLogo.png" alt="Projects" style={{width:'5rem', height:'auto', minHeight:''}}/>
